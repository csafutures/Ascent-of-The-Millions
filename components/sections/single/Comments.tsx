...
export default function Comments() {
  ...
  const topLevelComments = (commentsData as Comment[]).filter(c => !c.parentId);
  const replies = (commentsData as Comment[]).filter(c => c.parentId);
